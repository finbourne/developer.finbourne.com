...
<div class="container">    
    <section id="get-started" class="tiles">
      ...
      <a class="button main-c2a" href="/developer/lusid/get-started">Get Started</a>
    </section>
    ...
    <section class="tiles sdks" id="language-sdks">
        ...
        <ul>
            <li>
                <figure>   
                  <a href="/developer/lusid/languages/python"><img src="{images_base_uri}/thumbnail_python-logo.png" alt="Python Logo"></a>
                </figure>
            ...
            <li>
                <figure>
                    <a href="/developer/lusid/languages/csharp"><img src="{images_base_uri}/csharp-logo.png" alt="C# Logo"></a>
                </figure>
            ...
            <li>
                <figure>
                    <a href="/developer/lusid/languages/java"><img src="{images_base_uri}/java-logo.png" alt="Java Logo"></a>
                </figure>
            ...
            <li>
                <figure>
                    <a href="/developer/lusid/languages/javascript"><img src="{images_base_uri}/javascript-logo.png" alt="JavaScript Logo"></a>
                </figure>  
            </li>            
        </ul>
    </section>

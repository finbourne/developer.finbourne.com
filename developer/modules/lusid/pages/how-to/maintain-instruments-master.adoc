...
:description: In this guide we will learn how to maintain an instruments master. An instruments master typically contains details about our financial assets.
...
[source, python, indent=0]
----
include::example$instrument-master/test_instruments_master.py[tag="api-factory"]
----
...
We can also delete instruments.
...
But it's not permanently deleted from the system - if look back in time at our instruments or transactions based on those instruments, we will be able to find them.
====
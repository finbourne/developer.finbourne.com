...
[source, python, indent=0]
----
include::example$transaction-portfolio/test_transaction_portfolios.py[tag="api-factory"]
----

We're going to be using three different APIs in this guide: Transactions Portfolios, Portfolios, and Portfolios.

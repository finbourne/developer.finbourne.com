...
[source, python]
----
include::example$hello_world.py[tag="lusid-imports"]
----

.C#
[source, csharp]
----
include::example$HelloWorld.cs[tag="lusid-imports"]
----

.Java
[source, java]
----
include::example$HelloWorld.java[tag="lusid-imports"]
----
...
[source, python]
----
include::example$hello_world.py[tag="create-client-factory"]
----

.C#
[source, csharp, indent=0]
----
include::example$HelloWorld.cs[tag="create-client-factory"]
----

.Java
[source, java, indent=0]
----
include::example$HelloWorld.java[tag="create-client-factory"]
----
...
[source, python]
----
include::example$hello_world.py[tag="create-tx-portfolios-api"]

include::example$hello_world.py[tag="create-portfolio"]
----
...
[source, csharp, indent=0]
----
include::example$HelloWorld.cs[tag="create-tx-portfolios-api"]

include::example$HelloWorld.cs[tag="create-portfolio"]
----
...
[source, java, indent=0]
----
include::example$HelloWorld.java[tag="create-tx-portfolios-api"]

include::example$HelloWorld.java[tag="create-portfolio"]
----
...
[source, python]
----
include::example$hello_world.py[tag="upsert-instruments"]
----

.C#
[source, csharp, indent=0]
----
include::example$HelloWorld.cs[tag="upsert-instruments"]
----

.Java
[source, java, indent=0]
----
include::example$HelloWorld.java[tag="upsert-instruments"]
----
...
[source, python]
----
include::example$hello_world.py[tag="get-instruments"]
----

.C#
[source, csharp, indent=0]
----
include::example$HelloWorld.cs[tag="get-instruments"]
----

.Java
[source, java, indent=0]
----
include::example$HelloWorld.java[tag="get-instruments"]
----
...
[source, python]
----
include::example$hello_world.py[tag="upsert-transactions"]
----

.C#
[source, csharp, indent=0]
----
include::example$HelloWorld.cs[tag="upsert-transactions"]
----

.Java
[source, java, indent=0]
----
include::example$HelloWorld.java[tag="upsert-transactions"]
----
...
[source, python]
----
include::example$hello_world.py[tag="get-holdings"]
----
...
[source, csharp, indent=0]
----
include::example$HelloWorld.cs[tag="get-holdings"]
----
...
[source, java, indent=0]
----
include::example$HelloWorld.java[tag="get-holdings"]
----

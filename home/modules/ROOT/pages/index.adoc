...
<div class="container">    
    ...
    <section class="tiles sdks" id="language-sdks">
        ...
        <ul>
            <li>
                <figure>   
                  <a href="/lusid/languages/python"><img src="/static/assets/img/thumbnail_python-logo.png" alt="Python Logo"></a>
                </figure>
            ...
            <li>
                <figure>
                    <a href="/lusid/languages/csharp"><img src="/static/assets/img/csharp-logo.png" alt="C# Logo"></a>
                </figure>
            ...
            <li>
                <figure>
                    <a href="/lusid/languages/java"><img src="/static/assets/img/java-logo.png" alt="Java Logo"></a>
                </figure>
            ...
            <li>
                <figure>
                    <a href="/lusid/languages/javascript"><img src="/static/assets/img/javascript-logo.png" alt="JavaScript Logo"></a>
                </figure>  
            </li>            
        </ul>
    </section>
    ...
    <section class="tiles" id="notebooks">
        <h2 class="landing-page-section">Sample Notebooks</h2>
        <ul>
            <li>
                <figure>          
                    <img src="/static/assets/img/noun_portfolio_2484233.png" alt="A portfolio">
            ...
            <li>
                <figure>
                    <img src="/static/assets/img/noun_balance_142702.png" alt="Reconciliation">
            ...
            <li>
                <figure>
                    <img src="/static/assets/img/noun_transactions_2337768.png" alt="Investment Book of Record">
